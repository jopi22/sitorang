...
<head>
    ...
    <title>Sitorang-Barang Masuk</title>
        ...
        <div class="modal-content">
            ...
            <form method="post">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" name="keterangan" placeholder="Penerima" class="form-control" required><br>
                    <input type="number" name="qty" placeholder="Quantity" class="form-control" required><br>
                </div>

                <!-- Modal footer -->
                <div class="modal-footer">
                    <button class="btn btn-success" type="submit" name="barangmasuk">Submit</button>
            </form>
